...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for scaleway-cli.
...
download_release() {
  ...
  # TODO: Adapt the release URL convention for scaleway-cli
...
install_version() {
  ...
  local release_file="$install_path/scaleway-cli-$version.tar.gz"
  (
